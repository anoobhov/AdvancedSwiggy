export default function Header()
{
    return(
        <header className="bg-[#ff5200] font-serif">
            <div className="flex justify-between container mx-auto py-8 px-3">
                {/* Logo */}
                <img className="w-40 h-12" src="https://res.cloudinary.com/dutdah0l9/image/upload/v1720058694/Swiggy_logo_bml6he.png"></img>
                <div className="text-white text-base flex gap-10 items-center">
                    {/* etc etc */}
                    <a target="_blank" href="https://www.swiggy.com/corporate/">Swiggy Corporate</a>
                    <a target="_blank" href="https://partner.swiggy.com/login#/swiggy">Partner with Us</a>
                    <a className="border border-white rounded-2xl py-3 px-4" target="_blank" href="https://www.swiggy.com/corporate/">Get The App</a>
            ...
            <div className="relative pt-10 pb-8">
                ...
                <div className="max-w-[60%] text-5xl text-white font-bold contaner mx-auto text-center">
            ...
            <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
                <input className="bg-white w-[40%] text-xl px-6 py-4 rounded-xl" placeholder="Delhi, India"></input>
                <input className="bg-white w-[50%] text-xl px-6 py-4 rounded-xl" placeholder="Search for restaurant and items for more"></input>
            </div>

            <div className="max-w-[80%] container mx-auto flex pt-4">
